<?php
if (!class_exists('CF7TEL_Update_Checker')) {

    class CF7TEL_Update_Checker {
        ...
        public function __construct() {
            $utility = cf7tel_updater_utility();
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'cf7tel_plugin_updates';
